...
export default function Homepage() {
  return (
    <>
      ...
      <section>
        <h1 className="text-4xl font-bold tracking-tight text-black sm:text-5xl md:text-6xl text-center pt-20">
          No strings attached.
        </h1>
        <p className="sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl gap-2 text-center">
