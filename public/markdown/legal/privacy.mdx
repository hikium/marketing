...
Together with other entities (collectively, “Third-Parties”, each a “Third-Party”), the Hikium project (”Hikium,” “we”) is committed to protecting your personal data. This Privacy Statement outlines how we collect and use personal and technical data across Hikium Experience Composer and the Hikium marketing websites (collectively, the “Service”), effective from November 1, 2022.
...
- and the referring website or application.
...
## Data You Consent to Collection

### Personal Activity Data

After you consent (opt-in) to Personal Activity Data collection, the Service may collect data considered as personal data. This may include:

- the language of the web browser or application supporting software (which may be inherited from the operating system),
- the size of the screen of the device,
...
Personal Activity Data is considered personal data because it could identify you in some situations. For example, we could identify you if everyone we have collected data on is in the same room. However, overall, Personal Activity Data cannot identify you based on your constant personal characteristics and identifiers (for example, your name or postal address).
...
- or it is necessary for the purposes of the legitimate interests pursued by Hikium.

### Personal Activity Data

The collection of Personal Activity Data is lawful because:
...
### Aggregated Activity Data and Personal Activity Data

Aggregated Activity Data and Personal Activity Data is retained for as long as Hikium has a legitimate interest in the data.
